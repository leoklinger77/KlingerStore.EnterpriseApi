...
namespace KSE.Payment.KlingerPag.Models
{
    ...
    {
        public Transaction(KlingerPagService klingerPagService)
        {
        ...
        public Task<Models.Transaction> AuthorizeCardTransaction()
        {
        ...
        public Task<Models.Transaction> CaptureCardTransaction()
        {
        ...
        public Task<Models.Transaction> CancelAuthorization()
        {
            var transaction = new Transaction
            {
                AuthorizationCode = "",
